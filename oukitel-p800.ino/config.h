...
#define WARMUP_DELAY_DEFAULT              20000  // Changed from 5000 to 10000ms (10 seconds)
...
// ===================================================================
#define DEFAULT_WIFI_SSID     "SET-WIFI-SSID"
#define DEFAULT_WIFI_PASSWORD "SET-WIFI-PW"
...
const float BATTERY_CURVE_CHARGE[][2] = {
  {100.0, 28.90}, {99.0, 28.70}, {98.0, 28.50}, {97.0, 28.40}, 
  {95.0, 28.30}, {90.0, 28.20}, {85.0, 28.10}, {80.0, 28.00},
  {75.0, 27.90}, {70.0, 27.80}, {60.0, 27.60}, {50.0, 27.50},
  {40.0, 27.30}, {30.0, 27.20}, {20.0, 27.10}, {10.0, 26.60},
  {5.0, 25.50}, {0.0, 24.00}
};
